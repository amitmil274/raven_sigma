...
#include "autocircle_generater/raven_automove.h"
#include "autocircle_generater/raven_state.h"
...
using namespace autocircle_generater;
using namespace std;
...
void autoincrCallback(raven_automove);
...
*	\return void
*/
void autoincrCallback(raven_automove msg) //this was in local_io.cpp
{
